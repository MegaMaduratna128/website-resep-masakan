    ...
    <header class="header-area">
                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="deliciousNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    <li class="active"><a href="halamanuserbiasa.php">Home</a></li>
        ...
        <!-- Memunculkan Tabel -->
        	<div class="card col-sm-13" style="background-color: #F0F8FF;">
				<div class="card-body">
				<center>
				<h3><b>DAFTAR DATA RESEP BIASA</b></h3><br></center>
				<!-- Membuat tabel -->
...
<tbody>
	<?php 
	$data = mysqli_query($mysqli,"SELECT * FROM resep where id_jenis=1"); // memberikan perintah query sql untuk menampilkan semua data di tabel jual
	...
	<td>
		...
		<div class="btn-group" role="group" aria-label="Basic example">
			<a class="btn btn-warning" href="detailuserBiasa.php?id_resep=<?php echo $show['id_resep'];?>">DETAIL </a> 
		</div>
		</center>
	</td>
	</tr>
