...
<table class="table table-bordered table-hover">
    ...
    while($data = mysqli_fetch_assoc($result))
    {
      ...
      echo "<td>$data[tgl_transaksi]</td>"; //menampilkan data resep
      echo "<td>$data[nama]</td>"; //menampilkan data resep
      echo "<td>$data[jumlah_transaksi]</td>"; //menampilkan data resep
      ?>
      <td>&nbsp;&nbsp; <img src="transaksi/<?php echo $data['bukti_transaksi'];?>" width="100px">&nbsp;</td>
      <?php
